...
public class AuthTest extends BaseTest{
    ...
    public void checkRegister(){
        ...
        UserData newUser = checkStatusCodeGet("/register", user, 200)
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchemaInClasspath("resources/AuthSchema.json"))
    ...
    public void checkRegisterUnsuccessful(){
        ...
        Error error = checkStatusCodeGet("/register", user, 400)
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchemaInClasspath("resources/ErrorSchema.json"))
