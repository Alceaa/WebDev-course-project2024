...
public class ResourceTest extends BaseTest {
    ...
    public void checkListResource() {
        ResourceList resourceList = checkStatusCodeGet(200)
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchemaInClasspath("resources/ResourcesSchema.json"))
    ...
    public void checkResource(){
        ResourceSingle resource = checkStatusCodeGet("/2", 200)
                .assertThat()
                .body(JsonSchemaValidator.matchesJsonSchemaInClasspath("resources/SingleResourceSchema.json"))
